// ============================================
// Login Page — Redesigned (emerald/teal theme)
// ============================================
...
export default function Login() {
  ...
  return (
    <div className="min-h-dvh relative overflow-hidden flex flex-col bg-surface-950" style={{
      background: 'radial-gradient(ellipse at 30% 20%, rgba(16,185,129,0.12) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(20,184,166,0.08) 0%, transparent 50%), #060614',
    }}>
      {/* Ambient orbs */}
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 py-10 overflow-y-auto">
        <div className="w-full max-w-5xl flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full max-w-[420px] shrink-0">
            <div className="rounded-2xl border border-white/10 bg-surface-900/70 p-8 backdrop-blur-xl shadow-2xl shadow-black/40">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-surface-600 bg-surface-950/60 px-3.5 py-2.5 transition-colors focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-500/30">
